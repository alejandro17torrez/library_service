...
GENERAL_DIR = Path(__file__).resolve().parent.parent.parent
BASE_DIR = Path(__file__).resolve().parent.parent

ENVS_DIR = GENERAL_DIR / ".envs/.env"

load_dotenv(GENERAL_DIR)
...
DATABASES = {
    "default": {
        "ENGINE": f"django.db.backends.{os.environ.get('DB_DRIVER')}",
